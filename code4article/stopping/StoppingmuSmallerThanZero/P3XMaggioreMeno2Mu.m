%function p = P3MuMaggioreMenoXMinoreMaggiore2x(h,mu,s,x)
function p = P3XMaggioreMeno2Mu(h,mu,s,x)   
    ...
    p = exp(x/s)*( alpha_330+alpha_331*(x+2*mu)+alpha_332*(x+2*mu)^2 ) + exp(-x/s)*(beta_330 + beta_331*(x+2*mu));
